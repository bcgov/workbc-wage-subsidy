...
module.exports = {
    ...
    generateNotification: function (values) {
        ...
        for (var key in values) {
            if (key !== "_id" || key !== "emailSent" || key !== "savedReporting" || key !== "savedToSP"){
                if (key === "applicationID"){
                    html += `_id ${strings.orEmpty(values[key])} `;
                } else {
    ...
    generateListNotification: function(values) {
        ...
        for (var key in values) {
            ...
            if (key !== "_id" && key !== "emailSent" && key !== "savedReporting" && key !== "savedToSP"){
                if (key === "applicationID"){
                    html += `<p><b>applicationID:</b> ${strings.orEmpty(values[key])}</p>`;
    ...
    generateClaimNotification: function (values){
        ...
        <p>CA:  ${strings.orEmpty(values.ca)}</p>
    ...
    generateHaveEmployeeNotification: function(values){
        ...
        <p>Application ID:  ${strings.orEmpty(values.applicationID)}</p>
