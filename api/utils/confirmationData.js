...
module.exports = {
    getHaveEmployeeSubmitted(values){
        var data = [
            ...
            `<p>WorkSafeBC Insurance Coverage Number:  ${strings.orEmpty(values.WSBCNumber.toString())}</p>`,
            `<hr />`,
            `<h5>Employee Position 1 </h5>`,
            `<p>Operating Name:  ${strings.orEmpty(values.operatingName0)}</p>`,
            `<p>Number of Positions:  ${strings.orEmpty(values.numberOfPositions0.toString())}</p>`,
            ...
            `<p>StartDate:  ${strings.orEmpty(values.startDate0.toString())}</p>`,
            `<p>Hours: ${strings.orEmpty(values.hours0.toString())}</p>`,
            `<p>Wage: ${strings.orEmpty(values.wage0.toString())}</p>`,
            ...
            `<p>Number of Positions:  ${strings.orEmpty(values.numberOfPositions1.toString())}</p>`,
            ...
            `<p>StartDate:  ${strings.orEmpty(values.startDate0.toString())}</p>`,
            `<p>Hours: ${strings.orEmpty(values.hours1.toString())}</p>`,
            `<p>Wage: ${strings.orEmpty(values.wage1.toString())}</p>`,
            ...
            `<p>Organization Consent:  ${strings.orEmpty(values.organizationConsent.toString())}</p>`,
        ]
        return data
