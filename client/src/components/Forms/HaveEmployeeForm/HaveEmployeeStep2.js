...
class HaveEmployeeStep2 extends Component {
    constructor(){
        super()
        this.state = {
            positions: [{ operatingName: "", numberOfPositions: "", startDate: "", hours: "", wage: "", duties: "", email0: "", email1: "", email2: "", email3: "", email4: "", applicationMERCs: "" }],
        };
    }
    ...
    handleChange = (e) => {
        ...
        if (["operatingName", "numberOfPositions", "startDate", "hours", "wage", "duties", "email0", "email1", "email2", "email3", "email4", "applicationMERCs"].includes(e.target.className.split(" ")[0])) {
    ...
    addPosition = (e) => {
        ...
        this.setState((prevState) => ({
            positions: [...prevState.positions, { operatingName: "", numberOfPositions: "", startDate: "", hours: "", wage: "", duties: "", email0: "", email1: "", email2: "", email3: "", email4: "", applicationMERCs: "" }]
    ...
    removePosition = (e) => {
        ...
        this.props.values.applicationMERCs1=""
        this.setState((prevState) => ({
