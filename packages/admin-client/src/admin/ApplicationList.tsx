...
import { List, Datagrid, TextField, BooleanField, SimpleShowLayout, RichTextField, TopToolbar, FilterButton, SelectInput, CheckboxGroupInput } from 'react-admin';
...
const formFilters = [
    ...
    <CheckboxGroupInput source="completed" label=""
            choices={[
                {id:"New", name:"New"},
